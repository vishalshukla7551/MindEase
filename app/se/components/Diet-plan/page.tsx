...
export default function DietPlanForm() {
  ...
  return (
  //  <div className="max-w-4xl mx-auto px-4 pt-10 text-white">
  // <h1 className="text-4xl font-bold text-center mb-8">🥗 Create Your Personalized Diet Plan</h1>
  ...
  // <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className="md:col-span-2 flex flex-col">
      <label htmlFor="additional_preferences" className="mb-1 text-sm text-gray-400">
        Additional Preferences
      </label>
      <textarea
  ...
  {/* Submit button */}
  <div className="mt-8 mb-34 flex justify-center">
    <button
  ...
  {/* Response section */}
  {responsePlan && (
    <div ref={responseRef} className="bg-gray-900 p-6 rounded-xl whitespace-pre-wrap border border-gray-700">
